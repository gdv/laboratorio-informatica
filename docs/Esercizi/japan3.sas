...
Notare che in questo file le stazioni hanno una variabile STATION_ID
che è un numero progressivo che inizia con 1. */
...
/* Nel dataset otttenuto al punto 12 aggiungere una variabile DISTANZA_Q che
contiene il quadrato della distanza dal punto con latitudine 37.422972 e
longitudine 141.032917. */
data lib.stations;
	set lib.stations;
